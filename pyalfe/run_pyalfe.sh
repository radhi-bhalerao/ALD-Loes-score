...
input_file="/data/rauschecker1/lesionSegmentation/ALD_cont/radhika/processed_pyalfe/output.txt"

# Path to config.ini (update if necessary)
config_path="/data/rauschecker1/lesionSegmentation/ALD_cont/pyalfe/config.ini"
